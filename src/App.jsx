import Superior from "./components/superior.jsx";
import "./App.css";
    ...
    <>
      ...
      <div className="containerCard">
        <Inferior
          ...
          content="On demand File serving over native ESM, no bulding required!"
        />
        <Inferior
          icon="⚡"
        ...
        <Inferior
          ...
          content="Pre-configured Rollups build with multi-page and library mode support."
        />
        <Inferior
          icon="🔩"
